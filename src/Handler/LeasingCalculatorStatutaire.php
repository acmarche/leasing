...
#[AsTaggedItem(index: 'statutaire')]
#[AutoconfigureTag('app.leasing_calculator')]
class LeasingCalculatorStatutaire implements LeasingCalculatorInterface
{
    use CalculatorCommonTrait;

    /**
     * Disponible annuel de l'Allocation de Fin d'Année
     * =((F11+(C7*(C11/100)+C9*12)*0.025)*(C13/38))+F11*0.082666*0.1559
     * @return void
     */
    public function annualYearEndAllowanceAvailable(): void
    {
        ...
        $this->leasingData->annualYearEndAllowanceAvailable = (($F11 + ($C7 * ($C11 / 100) + $C9 * 12) * 0.025) * ($C13 / 38)) + $F11 * 0.082666 * 0.1559;
    }
     ...
     * =(((F11+(C7*(C11/100)+C9*12)*0.025)*(C13/38))-F11*0.082666*0.0355)*(1-F13)
     */
    public function estimateNetFullYearEndAllowance(): void
    {
        ...
        $this->leasingData->estimateNetFullYearEndAllowance = (((($F11 + ($C7 * ($C11 / 100) + $C9 * 12) * 0.025) * ($C13 / 38)) - $F11 * 0.082666 * 0.0355) * (1 - $F13));
    }
     ...
     * =F19-((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function agentNetContributionYear1(): void
    {
        ...
        $F17 = $this->leasingData->annualYearEndAllowanceAvailable;

        $this->leasingData->agentNetContributionYear1 = $F19 - (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I5 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
                    ? $F11 * 0.082666 * 0.0355
                    : (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) * 0.0355
                )
            ) * (1 - $F13);
    }
     ...
     * =F19-((F17-F11*0.082666*0.1559)-(I6-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function agentNetContributionYear2(): void
    {
        ...
        $this->leasingData->agentNetContributionYear2 = $F19 - (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I6 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
                    ? $F11 * 0.082666 * 0.0355
                    : (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) * 0.0355
     ...
     * =F19-((F17-F11*0.082666*0.1559)-(I7-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function agentNetContributionYear3(): void
    {
        ...
        $this->leasingData->agentNetContributionYear3 = $F19 - (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I7 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
                    ? $F11 * 0.082666 * 0.0355
                    : (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) * 0.0355
     ...
     * =((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function estimateNetYearEndAllowanceBalanceYear1(): void
    {
        ...
        $this->leasingData->estimateNetYearEndAllowanceBalanceYear1 = (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I5 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
     ...
     * =((F17-F11*0.082666*0.1559)-(I6-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function estimateNetYearEndAllowanceBalanceYear2(): void
    {
        ...
        $this->leasingData->estimateNetYearEndAllowanceBalanceYear2 = (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I6 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
     ...
     * =((F17-F11*0.082666*0.1559)-(I7-F11*0.082666*0.1559)-IF(((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))>F11,F11*0.082666*0.0355,((F17-F11*0.082666*0.1559)-(I5-F11*0.082666*0.1559))*0.0355))*(1-F13)
     */
    public function estimateNetYearEndAllowanceBalanceYear3(): void
    {
        ...
        $this->leasingData->estimateNetYearEndAllowanceBalanceYear3 = (
                ($F17 - $F11 * 0.082666 * 0.1559) -
                ($I7 - $F11 * 0.082666 * 0.1559) -
                (
                (($F17 - $F11 * 0.082666 * 0.1559) - ($I5 - $F11 * 0.082666 * 0.1559)) > $F11
